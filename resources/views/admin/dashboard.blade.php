...
@endsection
@push('style-library')
    <link rel="stylesheet" href="{{asset('admin_assets/vendors/flatpickr/flatpickr.min.css')}}">
@endpush
@push('script-library')
    <script src="{{asset('admin_assets/vendors/flatpickr/flatpickr.min.js')}}"></script>
    <script src="{{asset('admin_assets/vendors/apexcharts/apexcharts.min.js')}}"></script>
    <script src="{{asset('admin_assets/js/dashboard-dark.js')}}"></script>
@endpush
